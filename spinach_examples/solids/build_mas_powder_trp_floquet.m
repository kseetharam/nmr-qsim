...
function [spin_system, parameters, H1, R1, K1, H2, R2, K2] = build_mas_powder_trp_floquet()
...
% Simulation
[H1, R1, K1]=generator_floquet(spin_system,@acquire,parameters,'nmr');
...
% Simulation
[H2, R2, K2]=generator_floquet(spin_system,@acquire,parameters,'nmr');
