...
function [spin_system, parameters, H, R, K] = build_static_powder_gly()

% Spin system properties (PCM DFT calculation)
[sys,inter]=g2spinach(gparse('glycine.log'),...
...
% Simulation
[H, R, K]=generator_powder(spin_system,@acquire,parameters,'nmr');
