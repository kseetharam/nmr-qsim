...
def GenFID_SingJump_noTmix_GradField_MaxQD_Parallel(Ham, IntOps, JumpOps, T1, T2, rho0, coil, tmix, dt1, dt2, Ntmix, Lx, Ly, Lz):
    ...
    L_dt1 = expm(-1j*dt1*Hcoh) #BuildCohQDriftChann_fromOps(dt1,Norm_ops,pks,Gamma)
    ...
    L_dt2 = expm(-1j*Hcoh*dt2)#BuildCohQDriftChann_fromOps(dt2,Norm_ops,pks,Gamma)
...
if __name__=="__main__":
    ...
    with open('./data/ALA_SimplifiedFIDParallelmaxNQD_debug.pk', 'wb') as handle:
