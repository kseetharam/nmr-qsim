...
% save('generator_data/liquids/generators_noesyhsqc_ubiquitin_deut.mat', 'H', 'R', 'K', 'spin_system', 'parameters')
...
% save('generator_data/solids/generators_mas_powder_trp_gridfree.mat', 'H1', 'R1', 'K1', 'H2', 'R2', 'K2', 'spin_system', 'parameters')
