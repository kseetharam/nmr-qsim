...
diary('output_methyl_noesy_gb1_mod.txt');
...
%we save the list of nuclei that are going to be killed from the simulation
%as well as the inter object that contains the J couplings...
Couplings.inter = inter;
Couplings.carbon13 = strcmp('13C',spin_system.comp.isotopes);
Couplings.nitrogen15 = strcmp('15N',spin_system.comp.isotopes);
Couplings.deuterons = strcmp('2H',spin_system.comp.isotopes);

save('../circ_sim/notebooks/GB1/intercouplings.mat', 'Couplings');
