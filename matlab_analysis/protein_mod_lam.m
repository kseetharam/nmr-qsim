...
if ~isempty(options.deuterate)
    ...
    if iscell(options.deuterate)&&...
           ~strcmp(options.deuterate{1},'non-Me')
    ...
    % Residue-specific non-methyl deuteration option
    elseif iscell(options.deuterate)&&...
           strcmp(options.deuterate{1},'non-Me')
           disp("NOTE: deuterating the methyl HG protons for ILE");
        % Convert non-methyl protons into deuterons
        for n=1:numel(isotopes)

            % Find methyl protons
            this_be_methyl_proton=...
            (ismember('ALA',options.deuterate)&&strcmp(pdb_aa_typ{n},'ALA')&&ismember(pdb_atom_id{n},{'HB1','HB2','HB3'}))||...
            (ismember('ILE',options.deuterate)&&strcmp(pdb_aa_typ{n},'ILE')&&ismember(pdb_atom_id{n},{'HD11','HD12','HD13'}))||...
            (ismember('LEU',options.deuterate)&&strcmp(pdb_aa_typ{n},'LEU')&&ismember(pdb_atom_id{n},{'HD11','HD12','HD13','HD21','HD22','HD23'}))||...
            (ismember('MET',options.deuterate)&&strcmp(pdb_aa_typ{n},'MET')&&ismember(pdb_atom_id{n},{'HE1','HE2','HE3'}))||...
            (ismember('THR',options.deuterate)&&strcmp(pdb_aa_typ{n},'THR')&&ismember(pdb_atom_id{n},{'HG21','HG22','HG23'}))||...
            (ismember('VAL',options.deuterate)&&strcmp(pdb_aa_typ{n},'VAL')&&ismember(pdb_atom_id{n},{'HG11','HG12','HG13','HG21','HG22','HG23'}));
