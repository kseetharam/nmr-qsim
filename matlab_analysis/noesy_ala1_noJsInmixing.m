...
%getting the Hamiltonian without J couplings
...
[fid2,H_noJs,R2,rho02]=liquid_mod(spin_system,@noesy,parameters,'nmr');
...
[fid3,H_J12,R3,rho03]=liquid_mod(spin_system,@noesy,parameters,'nmr');
...
[fid3,H_J13,R3,rho03]=liquid_mod(spin_system,@noesy,parameters,'nmr');
...
[fid3,H_J14,R3,rho03]=liquid_mod(spin_system,@noesy,parameters,'nmr');
...
%mixing time evolution without J couplings...

pulse_mix = expm(-1i*H_noJs*parameters.tmix);
...
%load('../circ_sim/ALA_truncR_FIDcos_cohGrad.mat')
%load('../circ_sim/ALA_truncR_FIDsin_cohGrad.mat')
...
save NOESYdata_ALA_experiment_miscHJs.mat p
