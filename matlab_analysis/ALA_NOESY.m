...
%We use test fid to generate the spectrum
% fid.cos=apodisation(spin_system,fid_test.cos,{{'sqcos'},{'sqcos'}});
% fid.sin=apodisation(spin_system,fid_test.sin,{{'sqcos'},{'sqcos'}});
