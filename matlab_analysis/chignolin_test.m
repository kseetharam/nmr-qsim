...
[sys,inter]=protein_mod('./small_spin_systems/chignolin.pdb','./small_spin_systems/chignolin_2.bmrb',options);
%[sys,inter]=protein_mod('./small_spin_systems/chignolin.pdb',options);
...
save ./small_spin_systems/chignolin.mat spin_system
save ./small_spin_systems/chignolin_inter.mat inter
