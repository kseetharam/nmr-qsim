...
%
% <http://spindynamics.org/wiki/index.php?title=liquid.m>

function [rhot, rho0, obs_p, obs_z, H, R, K]=dyn_liquid(spin_system,pulse_sequence,parameters,assumptions)
...
[rhot, obs_p, obs_z]=pulse_sequence(spin_system,parameters,H,R,K);
